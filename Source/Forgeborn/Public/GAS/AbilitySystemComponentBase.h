 ...
 */
UCLASS()
class FORGEBORN_API UAbilitySystemComponentBase : public UAbilitySystemComponent
{
	GENERATED_BODY()
...
public:
	...
	void ApplyEffectToTarget(AActor* TargetActor, TSubclassOf<UGameplayEffect> GameplayEffectClass, float EffectLevel, const TMap<FGameplayTag, float>& SetByCallerMagnitudes);
